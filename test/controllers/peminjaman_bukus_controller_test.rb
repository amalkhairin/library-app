...
class PeminjamanBukusControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create peminjaman_buku' do
    assert_difference('PeminjamanBuku.count') do
      post peminjaman_bukus_url,
           params: { peminjaman_buku: { id_buku: @peminjaman_buku.id_buku, id_user: @peminjaman_buku.id_user, jadwal_kembali: @peminjaman_buku.jadwal_kembali, jadwal_pinjam: @peminjaman_buku.jadwal_pinjam, status: @peminjaman_buku.status } }, as: :json
    end
  ...
  test 'should update peminjaman_buku' do
    patch peminjaman_buku_url(@peminjaman_buku),
          params: { peminjaman_buku: { id_buku: @peminjaman_buku.id_buku, id_user: @peminjaman_buku.id_user, jadwal_kembali: @peminjaman_buku.jadwal_kembali, jadwal_pinjam: @peminjaman_buku.jadwal_pinjam, status: @peminjaman_buku.status } }, as: :json
    assert_response :success
  end
