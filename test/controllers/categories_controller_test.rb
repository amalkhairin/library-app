...
class CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update category if admin" do
    ...
    patch category_url(@category), params: { category: { name: "Matematika" } }, headers: {HTTP_AUTHORIZATION: "JWT #{@admin_token}"}
  ...
  test "should not update category if not admin" do
    ...
    patch category_url(@category), params: { category: { name: @category.name } }, headers: {HTTP_AUTHORIZATION: "JWT #{@user_token}"}
